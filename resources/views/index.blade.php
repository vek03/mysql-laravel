        ...
        <div class="row">
            <div class="container mb-3 col-12" style="background-color: white; padding: 35px;">
                <div class="card-body">
                    ...
                    <p>
                        <form method="post" action="{{ route('create-db') }}" id="form" name="form">
                            @csrf
                            ...
                            <div class="mb-3  form-group">
                                ...
                                <input type="tel" class="form-control" required name="tel" id="tel" placeholder="(xx)xxxxx-xxxx">
                            </div>
                            <div class="mb-3 form-group">
                            ...
                            <div class="mb-3 form-group">
                                ...
                                <input type="date" class="form-control" required name="dt_ctt" id="dt_ctt">
                            </div>
                            <div class="mb-3 form-group">
